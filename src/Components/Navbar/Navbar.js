    ...
    <div className="logo">
      ...
      <div className="navbar1">
        ...
        {/* <span className="search">
          ...
          <AiIcons.AiFillBell  style={{fontSize:"40px",cursor:"pointer"}} onClick={notify}/><span className="badge" style={{position:"relative", top:" -15px", left: "-15px",borderRadius: "50%",backgroundColor:"red"}}>{numOfSeen}</span>
          </span>
